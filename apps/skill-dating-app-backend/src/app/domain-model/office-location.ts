...
import { OfficeLocationTo } from '@less-code-challenge/api-interfaces';
...
export class OfficeLocation {
  ...
  toPlainAttributes(): OfficeLocationTo {
   return  {
      [Region.attributeName]: this.region.value,
      [Country.attributeName]: this.country.value,
      [Office.attributeName]: this.office.value
    };
  }
}
