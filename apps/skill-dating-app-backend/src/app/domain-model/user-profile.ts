...
export class UserProfile {
  ...
  toPlainAttributesSkippingSkills(): UserProfileTo {
    return {
      [Username.attributeName]: this.username.value,
      [UserProfileDescription.attributeName]: this.description?.value,
      [PhoneNo.attributeName]: this.phoneNo?.value,
      [OfficeLocation.attributeName]: this.officeLocation?.toPlainAttributes(),
      [OfficeLocation.attributeName]: this.officeLocation?.toPlainAttributes(),

    };
  }

  toPlainAttributes(): UserProfileTo { 
    return {
      ...this.toPlainAttributesSkippingSkills(),
      [skillsAttributeName]: this.skills?.map(skill => skill.toPlainAttributes())}
  }
